...
if __name__ == '__main__':
    ...
    parser.add_argument('--resize_to', type=int, default=640, help='Resize the image for training and transforms')
    ...
    parser.add_argument('--train_dir', type=str, default='data/train',
                        help='Training images and XML files directory')
    parser.add_argument('--valid_dir', type=str, default='data/valid',
                        help='Validation images and XML files directory')
